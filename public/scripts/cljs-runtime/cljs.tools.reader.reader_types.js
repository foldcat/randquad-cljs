...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12031 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12031(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12035 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12035(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12036 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12036(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12039 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12039(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12042 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12042(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12043 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12043(reader);
}
});
...
var G__12095 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__12096 = s.append(c);
c = G__12095;
s = G__12096;
continue;
}
