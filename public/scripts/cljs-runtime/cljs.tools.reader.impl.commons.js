...
var G__12608 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
ch = G__12608;
continue;
} else {
return ch;
...
var vec__12586 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12586,(0),null);
return (match === s);
});
...
var G__12616 = (i__5727__auto___12615 + (1));
i__5727__auto___12615 = G__12616;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq12594){
...
return (function() { 
var G__12617__delegate = function (rdr,_){
...
var G__12617 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__12618__i = 0, G__12618__a = new Array(arguments.length -  1);
while (G__12618__i < G__12618__a.length) {G__12618__a[G__12618__i] = arguments[G__12618__i + 1]; ++G__12618__i;}
  _ = new cljs.core.IndexedSeq(G__12618__a,0,null);
} 
return G__12617__delegate.call(this,rdr,_);};
G__12617.cljs$lang$maxFixedArity = 1;
G__12617.cljs$lang$applyTo = (function (arglist__12619){
var rdr = cljs.core.first(arglist__12619);
var _ = cljs.core.rest(arglist__12619);
return G__12617__delegate(rdr,_);
});
