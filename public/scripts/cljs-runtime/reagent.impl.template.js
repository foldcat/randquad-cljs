...
var G__11842 = o;
reagent.impl.template.goog$module$goog$object.set(G__11842,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__11861__i < G__11861__a.length) {G__11861__a[G__11861__i] = arguments[G__11861__i + 0]; ++G__11861__i;}
  args = new cljs.core.IndexedSeq(G__11861__a,0,null);
} 
...
var G__11843 = o;
reagent.impl.template.goog$module$goog$object.set(G__11843,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__11863__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__11864__i < G__11864__a.length) {G__11864__a[G__11864__i] = arguments[G__11864__i + 0]; ++G__11864__i;}
  args = new cljs.core.IndexedSeq(G__11864__a,0,null);
} 
...
var G__11844 = props;
var G__11844__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11844,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11844);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11844__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__11845 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__11845,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__11845;
}
})(),id_class);
...
var G__11846 = (cljs.core.count(argv) - first_child);
switch (G__11846) {
case (0):
...
var vec__11847 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11847,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11847,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11847,(2),null);
...
var temp__5808__auto___11869 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11869 == null)){
} else {
var key_11870 = temp__5808__auto___11869;
(jsprops.key = key_11870);
}
...
var temp__5808__auto___11875 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___11875 == null)){
} else {
var key_11877 = temp__5808__auto___11875;
(jsprops.key = key_11877);
}
...
var temp__5808__auto___11879 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___11879 == null)){
} else {
var key_11880 = temp__5808__auto___11879;
(jsprops.key = key_11880);
}
...
var temp__5808__auto___11887 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11887 == null)){
} else {
var key_11888 = temp__5808__auto___11887;
(jsprops.key = key_11888);
}
...
var temp__5808__auto___11889 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___11889 == null)){
} else {
var key_11891 = temp__5808__auto___11889;
(jsprops.key = key_11891);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11850_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__11850_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__11851 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11851,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11851,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template11857 = (function (opts,id,fn_to_element,parse_fn,meta11858){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template11857.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11859,meta11858__$1){
var self__ = this;
var _11859__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template11857(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta11858__$1));
}));

(reagent.impl.template.t_reagent$impl$template11857.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11859){
var self__ = this;
var _11859__$1 = this;
return self__.meta11858;
}));

(reagent.impl.template.t_reagent$impl$template11857.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template11857.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template11857.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template11857.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template11857.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template11857.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta11858","meta11858",270580674,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template11857.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template11857.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template11857");

(reagent.impl.template.t_reagent$impl$template11857.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template11857");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template11857.
 */
reagent.impl.template.__GT_t_reagent$impl$template11857 = (function reagent$impl$template$__GT_t_reagent$impl$template11857(opts,id,fn_to_element,parse_fn,meta11858){
return (new reagent.impl.template.t_reagent$impl$template11857(opts,id,fn_to_element,parse_fn,meta11858));
});
...
return (new reagent.impl.template.t_reagent$impl$template11857(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
