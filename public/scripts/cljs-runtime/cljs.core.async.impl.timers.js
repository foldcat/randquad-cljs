...
var i_14363 = (self__.level + (1));
while(true){
if((i_14363 <= (new_level + (1)))){
(update[i_14363] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14365 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14365[i]));
} else {
x__$2.forward.push((((i < links_14365.length))?(links_14365[i]):null));
}

if((i < links_14365.length)){
(links_14365[i] = x__$2);
} else {
links_14365.push(x__$2);
}
...
var i_14369 = (0);
while(true){
if((i_14369 <= self__.level)){
var links_14370 = (update[i_14369]).forward;
if((x__$1 === (((i_14369 < links_14370.length))?(links_14370[i_14369]):null))){
(links_14370[i_14369] = (x__$1.forward[i_14369]));

var G__14371 = (i_14369 + (1));
i_14369 = G__14371;
continue;
} else {
var G__14372 = (i_14369 + (1));
i_14369 = G__14372;
continue;
}
} else {
