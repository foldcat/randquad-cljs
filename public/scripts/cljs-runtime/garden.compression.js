 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__11379){
var vec__11388 = p__11379;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11388,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11388,(1),null);
return (function (s){
...
while(true){
if((i__5727__auto___11550 < len__5726__auto___11547)){
args__5732__auto__.push((arguments[i__5727__auto___11550]));

var G__11553 = (i__5727__auto___11550 + (1));
i__5727__auto___11550 = G__11553;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__5733__auto__);
});
...
return (function (s){
return cljs.core.some((function (p1__11445_SHARP_){
return (p1__11445_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__11445_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__11445_SHARP_.call(null, s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq11448){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq11448));
}));
...
var map__11510 = temp__5802__auto__;
var map__11510__$1 = cljs.core.__destructure_map(map__11510);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11510__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11510__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11510__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__11592 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__11593 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__11513 = tag;
var G__11513__$1 = (((G__11513 instanceof cljs.core.Keyword))?G__11513.fqn:null);
switch (G__11513__$1) {
case "string":
return chunk;
