 ...
 */
garden.units.convert = (function garden$units$convert(p__13091,right){
var map__13092 = p__13091;
var map__13092__$1 = cljs.core.__destructure_map(map__13092);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13092__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__13093 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13093,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13093,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13093,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13096__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13097 = u(y);
var map__13097__$1 = cljs.core.__destructure_map(map__13097);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13097__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__13105__delegate = function (x,y,more){
...
while (G__13106__i < G__13106__a.length) {G__13106__a[G__13106__i] = arguments[G__13106__i + 2]; ++G__13106__i;}
  more = new cljs.core.IndexedSeq(G__13106__a,0,null);
} 
...
var more = cljs.core.rest(arglist__13107);
...
G__13108 = new cljs.core.IndexedSeq(G__13109__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13108);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13098__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13099 = u(y);
var map__13099__$1 = cljs.core.__destructure_map(map__13099);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13099__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
while (G__13111__i < G__13111__a.length) {G__13111__a[G__13111__i] = arguments[G__13111__i + 2]; ++G__13111__i;}
  more = new cljs.core.IndexedSeq(G__13111__a,0,null);
} 
...
var more = cljs.core.rest(arglist__13112);
...
G__13113 = new cljs.core.IndexedSeq(G__13114__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13113);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__13100 = u(x);
var map__13100__$1 = cljs.core.__destructure_map(map__13100);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13100__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13101 = u(y);
var map__13101__$1 = cljs.core.__destructure_map(map__13101);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13101__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
while (G__13118__i < G__13118__a.length) {G__13118__a[G__13118__i] = arguments[G__13118__i + 2]; ++G__13118__i;}
  more = new cljs.core.IndexedSeq(G__13118__a,0,null);
} 
...
G__13120 = new cljs.core.IndexedSeq(G__13121__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13120);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__13102 = u(x);
var map__13102__$1 = cljs.core.__destructure_map(map__13102);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13102__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13103 = u(y);
var map__13103__$1 = cljs.core.__destructure_map(map__13103);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13103__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null, m1,m2)));
});
...
var more = null;
if (arguments.length > 2) {
var G__13127__i = 0, G__13127__a = new Array(arguments.length -  2);
while (G__13127__i < G__13127__a.length) {G__13127__a[G__13127__i] = arguments[G__13127__i + 2]; ++G__13127__i;}
  more = new cljs.core.IndexedSeq(G__13127__a,0,null);
} 
...
while (G__13131__i < G__13131__a.length) {G__13131__a[G__13131__i] = arguments[G__13131__i + 2]; ++G__13131__i;}
G__13130 = new cljs.core.IndexedSeq(G__13131__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13130);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
